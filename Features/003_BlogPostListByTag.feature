Feature: Listing blog posts by tag
  As a Visitor
  I want to browse through blog post list connected to given tag
  ...
  Scenario: Viewing posts list by "symfony" tag
     When I go to /blog/tag/symfony
  ...
  Scenario: Viewing posts list by "does-not-exists" tag which does not exists in database
     When I go to /blog/tag/does-not-exists
